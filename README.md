...
A self-paced networking + systems administration curriculum tracker, built as a single-file interactive web app. Covers everything from home-network basics through enterprise switching/routing to Windows Server Active Directory — aligned to **CCNA 200-301 v1.1** and **AZ-800**.
...
**46 modules · 56 guided labs · ~220 hours** of self-paced content, each module with a written overview, learning objectives, key topics, and hands-on Packet Tracer / VirtualBox labs.
...
4. Courses 1–3 use **Cisco Packet Tracer** (free via the Cisco Networking Academy / Skills for All). Course 4 uses **VirtualBox** with a free 180-day Windows Server 2025 evaluation.
...
Content maps to **CCNA 200-301 v1.1** (the 2025+ exam blueprint — Rapid PVST+, WPA3, IaaS/PaaS/SaaS, cloud-managed networking) for courses 1–3, and **AZ-800** (Windows Server hybrid administration) fundamentals for course 4.
